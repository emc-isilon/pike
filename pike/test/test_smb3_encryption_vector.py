...
class TestVector(unittest.TestCase):
    def test_pre_auth_integrity(self):
        ...
        exp_pae_1 = array.array('B', unhexlify(
        ...
        negotiate_response = array.array('B', unhexlify(
        ...
        exp_pae_2 = array.array('B', unhexlify(
        ...
        session_setup_request = array.array('B', unhexlify(
        ...
        exp_pae_3 = array.array('B', unhexlify(
        ...
        session_setup_response = array.array('B', unhexlify(
        ...
        exp_pae_4 = array.array('B', unhexlify(
        ...
        session_setup_response2 = array.array('B', unhexlify(
        ...
        exp_pae_5 = array.array('B', unhexlify(
    ...
    def test_encryption_smb_300(self):
        ...
        exp_encrypted = array.array('B', unhexlify(
        ...
        exp_transformed = array.array('B', unhexlify(
    ...
    def test_decryption_smb_300(self):
        ...
        self.assertEqual(conn.encryption_context().keys.decryption,
                         exp_decryption_key)
        transform_message = array.array('B', unhexlify(
        ...
        exp_smb_message = array.array('B', unhexlify(
    ...
    def test_encryption_smb_311(self):
        ...
        pre_auth_integrity_hash = array.array('B', unhexlify(
        ...
        conn = bogus_311_connection(session_key,
                                    pre_auth_integrity_hash,
                                    ciphers)
